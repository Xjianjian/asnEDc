 ...
 * 	found in "/home/intest/hozon/asnEDc/asn1c-0.9.28/tests/127-per-long-OK.asn1"
...
static asn_TYPE_member_t asn_MBR_T_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct T, small32range),
		...
		memb_small32range_constraint_1,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct T, full32range),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		memb_full32range_constraint_1,
		&asn_PER_memb_full32range_constr_3,
		0,
		"full32range"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct T, unsigned32),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_unsigned32_4,
		memb_unsigned32_constraint_1,
		&asn_PER_memb_unsigned32_constr_4,
		0,
		"unsigned32"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct T, unsplit32),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_unsplit32_5,
		memb_unsplit32_constraint_1,
		&asn_PER_memb_unsplit32_constr_5,
		0,
		"unsplit32"
		},
};
