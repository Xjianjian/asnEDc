...
static int
memb_dataType_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_dataType_constr_2 GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_ImageAcquisitionReqInfo_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ImageAcquisitionReqInfo, dataType),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		memb_dataType_constraint_1,
		&asn_PER_memb_dataType_constr_2,
		0,
		"dataType"
		},
...
asn_TYPE_descriptor_t asn_DEF_ImageAcquisitionReqInfo = {
	...
	asn_DEF_ImageAcquisitionReqInfo_tags_1,
	sizeof(asn_DEF_ImageAcquisitionReqInfo_tags_1)
		/sizeof(asn_DEF_ImageAcquisitionReqInfo_tags_1[0]), /* 1 */
	asn_DEF_ImageAcquisitionReqInfo_tags_1,	/* Same as above */
	sizeof(asn_DEF_ImageAcquisitionReqInfo_tags_1)
		/sizeof(asn_DEF_ImageAcquisitionReqInfo_tags_1[0]), /* 1 */
