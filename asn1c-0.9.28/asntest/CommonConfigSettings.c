...
static asn_TYPE_member_t asn_MBR_CommonConfigSettings_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CommonConfigSettings, carEmpowerEnabled),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CommonConfigSettings, eventReportEnabled),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CommonConfigSettings, carAlarmEnabled),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CommonConfigSettings, heartbeatTimeout),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CommonConfigSettings, dormancyHeartbeatTimeout),
