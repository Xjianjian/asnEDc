...
static asn_per_constraints_t asn_PER_type_diagCommand_constr_2 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 8,  8,  1,  255 }	/* (SIZE(1..255)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_diagCommand_constr_2 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 8,  8,  1,  255 }	/* (SIZE(1..255)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_diagCommand_2[] = {
	{ ATF_POINTER, 0, 0,
...
static const ber_tlv_tag_t asn_DEF_diagCommand_tags_2[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_diagCommand_specs_2 = {
	sizeof(struct diagCommand),
	offsetof(struct diagCommand, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_diagCommand_2 = {
	"diagCommand",
	"diagCommand",
	SEQUENCE_OF_free,
	SEQUENCE_OF_print,
	...
	asn_DEF_diagCommand_tags_2,
	sizeof(asn_DEF_diagCommand_tags_2)
		/sizeof(asn_DEF_diagCommand_tags_2[0]) - 1, /* 1 */
	asn_DEF_diagCommand_tags_2,	/* Same as above */
	sizeof(asn_DEF_diagCommand_tags_2)
		/sizeof(asn_DEF_diagCommand_tags_2[0]), /* 2 */
	&asn_PER_type_diagCommand_constr_2,
	asn_MBR_diagCommand_2,
	1,	/* Single element */
	&asn_SPC_diagCommand_specs_2	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_DiagnosticReqInfo_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DiagnosticReqInfo, diagCommand),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_diagCommand_2,
		memb_diagCommand_constraint_1,
		&asn_PER_memb_diagCommand_constr_2,
		0,
		"diagCommand"
		},
};
...
static const asn_TYPE_tag2member_t asn_MAP_DiagnosticReqInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* diagCommand */
};
