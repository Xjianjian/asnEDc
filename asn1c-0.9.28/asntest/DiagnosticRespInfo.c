...
static asn_TYPE_member_t asn_MBR_DiagnosticRespInfo_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DiagnosticRespInfo, diagType),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DiagnosticRespInfo, result),
	...
	{ ATF_POINTER, 2, offsetof(struct DiagnosticRespInfo, failureType),
...
static const ber_tlv_tag_t asn_DEF_DiagnosticRespInfo_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_DiagnosticRespInfo_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_DiagnosticRespInfo_specs_1 = {
	...
	offsetof(struct DiagnosticRespInfo, _asn_ctx),
	asn_MAP_DiagnosticRespInfo_tag2el_1,
	4,	/* Count of tags in the map */
	asn_MAP_DiagnosticRespInfo_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_DiagnosticRespInfo = {
	"DiagnosticRespInfo",
	"DiagnosticRespInfo",
	SEQUENCE_free,
	SEQUENCE_print,
	...
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_DiagnosticRespInfo_tags_1,
	sizeof(asn_DEF_DiagnosticRespInfo_tags_1)
		/sizeof(asn_DEF_DiagnosticRespInfo_tags_1[0]), /* 1 */
	asn_DEF_DiagnosticRespInfo_tags_1,	/* Same as above */
	sizeof(asn_DEF_DiagnosticRespInfo_tags_1)
		/sizeof(asn_DEF_DiagnosticRespInfo_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_DiagnosticRespInfo_1,
	4,	/* Elements count */
	&asn_SPC_DiagnosticRespInfo_specs_1	/* Additional specs */
};
